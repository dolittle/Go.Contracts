...
func (c *handshakeClient) Handshake(ctx context.Context, in *HandshakeRequest, opts ...grpc.CallOption) (*HandshakeResponse, error) {
	out := new(HandshakeResponse)
	err := c.cc.Invoke(ctx, "/dolittle.runtime.handshake.Handshake/Handshake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHandshakeServer) Handshake(context.Context, *HandshakeRequest) (*HandshakeResponse, error) {
...
func _Handshake_Handshake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dolittle.runtime.handshake.Handshake/Handshake",
	}
...
var Handshake_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dolittle.runtime.handshake.Handshake",
	...
	Metadata: "Runtime/Handshake/Handshake.proto",
}
