...
type EventHandlerRegistrationRequest struct {
	...
	Batched        bool                                  `protobuf:"varint,7,opt,name=batched,proto3" json:"batched,omitempty"` // Whether the processor is batched or not. TODO: We could drop this and have a flag in the Runtime that gets turned on for batching when using this version of the contracts or greater
}
...
type HandleEventsRequest struct {
	...
	Event                *StreamEvent          `protobuf:"bytes,2,opt,name=event,proto3" json:"event,omitempty"` // For use with older SDKs that does not support batching
	...
	Batch                []*StreamEvent        `protobuf:"bytes,4,rep,name=batch,proto3" json:"batch,omitempty"` // The batch of events to handle
}
...
func (x *HandleEventsRequest) GetCallContext() *services.ReverseCallRequestContext {
	if x != nil {
		return x.CallContext
	}
	return nil
...
// Deprecated: Do not use.
func (x *HandleEventsRequest) GetEvent() *StreamEvent {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *HandleEventsRequest) GetRetryProcessingState() *RetryProcessingState {
	if x != nil {
...
func (x *HandleEventsRequest) GetBatch() []*StreamEvent {
	if x != nil {
		return x.Batch
	}
	return nil
...
func (x *EventHandlerRuntimeToClientMessage) GetHandleRequest() *HandleEventsRequest {
...
type EventHandlerRuntimeToClientMessage_HandleRequest struct {
	HandleRequest *HandleEventsRequest `protobuf:"bytes,2,opt,name=handleRequest,proto3,oneof"`
}
...
var file_Runtime_Events_Processing_EventHandlers_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x22, 0xe5, 0x02, 0x0a, 0x13, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x4e, 0x0a, 0x0b, 0x63, 0x61,
	...
	0x61, 0x6c, 0x6c, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12, 0x49, 0x0a, 0x05, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x64, 0x6f, 0x6c, 0x69,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x02, 0x18, 0x01, 0x52, 0x05,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x6c, 0x0a, 0x14, 0x72, 0x65, 0x74, 0x72, 0x79, 0x50, 0x72,
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20,
	...
	0x61, 0x74, 0x65, 0x12, 0x45, 0x0a, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x64, 0x6f, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x2e, 0x72, 0x75,
	0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x52, 0x05, 0x62, 0x61, 0x74, 0x63, 0x68, 0x22, 0xbb, 0x02, 0x0a, 0x22, 0x45,
	...
	0x65, 0x12, 0x7a, 0x0a, 0x14, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x2e, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52,
	...
	0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xaf, 0x01, 0x0a, 0x0d, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x73, 0x12, 0x9d, 0x01, 0x0a, 0x07, 0x43,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x46, 0x2e, 0x64, 0x6f, 0x6c, 0x69, 0x74, 0x74, 0x6c,
	...
	0x74, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x6f,
	0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x46,
	0x2e, 0x64, 0x6f, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	0x65, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x69, 0x6e, 0x67, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72,
	0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x66, 0x5a, 0x35, 0x67, 0x6f,
	...
	0x69, 0x6e, 0x67, 0xaa, 0x02, 0x2c, 0x44, 0x6f, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x2e, 0x52,
	0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x50, 0x72,
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63,
...
var file_Runtime_Events_Processing_EventHandlers_proto_goTypes = []interface{}{
	...
	(*HandleEventsRequest)(nil),                  // 4: dolittle.runtime.events.processing.HandleEventsRequest
...
var file_Runtime_Events_Processing_EventHandlers_proto_depIdxs = []int32{
	...
	13, // 10: dolittle.runtime.events.processing.HandleEventsRequest.callContext:type_name -> dolittle.services.ReverseCallRequestContext
	14, // 11: dolittle.runtime.events.processing.HandleEventsRequest.event:type_name -> dolittle.runtime.events.processing.StreamEvent
	15, // 12: dolittle.runtime.events.processing.HandleEventsRequest.retryProcessingState:type_name -> dolittle.runtime.events.processing.RetryProcessingState
	14, // 13: dolittle.runtime.events.processing.HandleEventsRequest.batch:type_name -> dolittle.runtime.events.processing.StreamEvent
	3,  // 14: dolittle.runtime.events.processing.EventHandlerRuntimeToClientMessage.registrationResponse:type_name -> dolittle.runtime.events.processing.EventHandlerRegistrationResponse
	4,  // 15: dolittle.runtime.events.processing.EventHandlerRuntimeToClientMessage.handleRequest:type_name -> dolittle.runtime.events.processing.HandleEventsRequest
	16, // 16: dolittle.runtime.events.processing.EventHandlerRuntimeToClientMessage.ping:type_name -> dolittle.services.Ping
	2,  // 17: dolittle.runtime.events.processing.EventHandlers.Connect:input_type -> dolittle.runtime.events.processing.EventHandlerClientToRuntimeMessage
	5,  // 18: dolittle.runtime.events.processing.EventHandlers.Connect:output_type -> dolittle.runtime.events.processing.EventHandlerRuntimeToClientMessage
